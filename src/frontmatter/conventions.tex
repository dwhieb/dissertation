...
% language info
The first mention of a language within each chapter is followed by information about its geneaological affiliation (in the format \textit{family > phylum}) \todo{add styling for code blocks (\href{https://github.com/dwhieb/dissertation/issues/544}{\#544})} and the location where it is spoken. For example, Central Alaskan Yup'ik would appear as ``Central Alaskan Yup'ik (Eskimo-Aleut > Eskimo; Alaska)". \todo{add quotes package (\href{https://github.com/dwhieb/dissertation/issues/545}{\#545})}
