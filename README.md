...
`function: X`       | Item is sound-imitative, a discourse hesitation, a conjunction (_waa_ 'and', _ʔuḥ_ 'and'), a complementizer (_ʔan_ 'that, because'), a vocative, or a mention rather than a use.
