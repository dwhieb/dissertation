...
\begin{description}
  \item[functional expansion] A diachronic expansion in the range of uses of a lexical item (root, stem, or inflected word) into a new discourse function (reference, predication, or modification) with zero coding for that new function.
\end{description}
