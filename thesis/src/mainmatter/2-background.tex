...
\begin{figure}[h]
  ...
  \caption{distributional analysis of English temporal nouns \parencite[54]{Crystal1967}}
  \label{fig:English-distributions-b}
\end{figure}

\begin{figure}[h]
  \includegraphics[width=\linewidth]{Russian-distributions.jpg}
  \caption{distributional analysis of Russian numerals \parencite[359]{Corbett1978}}
  \label{fig:Russian-distributions}
\end{figure}

\begin{figure}[h]
  \includegraphics[width=\linewidth]{French-distributions.jpg}
  \caption{distributional analysis of French verbs \parencite[860]{Gross1979}}
