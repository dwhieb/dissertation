...
\begin{figure}[h!]
  ...
  \caption[distributional analysis of English temporal nouns]{distributional analysis of English temporal nouns \parencite[54]{Crystal1967}}
  \label{fig:English-distributions-b}
\end{figure}

\begin{figure}[h!]
  \includegraphics[width=\linewidth]{Russian-distributions.jpg}
  \caption[distributional analysis of Russian numerals]{distributional analysis of Russian numerals \parencite[359]{Corbett1978}}
  \label{fig:Russian-distributions}
\end{figure}

\begin{figure}[h!]
  \includegraphics[width=\linewidth]{French-distributions.jpg}
  \caption[distributional analysis of French verbs]{distributional analysis of French verbs \parencite[860]{Gross1979}}
...
\begin{exe}
  ...
  \ex\label{ex:2.3}
  \exinfo{Dutch (Indo-European > Germanic)}
  \begin{xlist}
  ...
  \ex\label{ex:2.4}
  \exinfo{Wambon (Trans-New Guinea > Greater Awyu)}
...
\begin{exe}
  \ex\label{ex:2.7}
  \hspace{0.5em}\exinfo{Standard Arabic (Afroasiatic > Semitic)}\\
...
\begin{exe}
  ...
  \ex\label{ex:2.11}
  \exinfo{Cayuga (Iroquoian > Lake Iroquoian)}
  \begin{xlist}
...
\begin{exe}
  \ex\label{ex:2.13}
  \exinfo{Central Alaskan Yup'ik (Eskimo-Aleut > Yupik)}
  \begin{xlist}
...
\begin{landscape}
  \begin{figure}[h!]
    ...
    \caption[Semantic map of English \textit{run}]{Semantic map of English \textit{run} \parencite[74]{Gries2006}}
