...
\blockquote[{\cite[175--176]{Gallatin1836}}]{It is the substantive \textins{i.e. copula / auxiliary} verb which we \textins{speakers of Indo-European languages} conjugate; whilst the \textins{Native American} conjugates what we call the adjective and even the noun itself, in the same manner as \textins{s/he} does other intransitive verbs. \textelp{} I believe it must appear sufficiently obvious, that this general if not universal character of the \textins{Native American} languages, the conversion into verbs and the conjugation, through all the persons, tense, and moods, of almost all the adjectives and of every noun which, without a palpable absurdity, is suspectible of it, is entirely due to the absence of the substantive verb.}
