...
This section discusses the specific statistical measures used in this study. In \secref*{sec:3.4.1} I discuss the use of token frequencies versus dispersion, and in \secref*{sec:3.4.2}, I present the measure used to quantify the lexical flexibility of individual items in a corpus.
