...
\begin{figure}
  ...
  \centering
  \caption{Flexibility of Nuuchahnulth \textit{ʔu·q} \tln{good}}
  \label{fig:Nuu-good}
...
How then is lexical flexibility realized in English and Nuuchahnulth? In addition to the histograms in \figref{fig:histogram-100-items} and \figref{fig:histogram-small-corpus}, the ternary plots in \figref{fig:ternary-100-items} and \figref{fig:ternary-small-corpus} illustrate the way that flexibility operates in these two languages. In these figures, each lexical item is represented by a single point on the ternary plot.
...
\TODO[inline]{add examples for all-things, and two-canoe}
