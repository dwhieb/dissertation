...
\figref{fig:cumulative-functional-diversity-English-items} shows the result of these calculations for the ten most frequent words in the \idx{English} corpus, and \figref{fig:cumulative-functional-diversity-Nuuchahnulth-items} shows the same for \idx{Nuuchahnulth}. The number of tokens encountered is shown on the x-axis, and the cumulative flexibility is shown on the y-axis. In other words, these plots show how the flexibility of the lexical item changes as the size of the corpus grows.
