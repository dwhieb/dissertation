...
\noindent I again used the 100-item sample for the English model, and the entire corpus for Nuuchahnulth.
...
\TODO[inline]{finalize this table; the data already here are correct}
% indefinites
