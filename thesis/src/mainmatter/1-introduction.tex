...
\TODO[inline]{finalize the findings on flexibility vs. corpus size, especially the reliability size}

In relation to \ref{R2}, \enquote{Is there a correlation between degree of lexical flexibility and size of the corpus?}, I find that there is indeed a strong correlation between the two in English for sample corpus sizes up to approximately 100,000 words, after which the relative increase in flexibility drops off precipitously. In other words, a corpus of at least 100,000 words provides a fairly reliable representation of the actual flexibility of its words. The data for Nuuchahnulth are consistent with the findings for English, but the overall corpus size for Nuuchahnulth is too small to say with confidence that the same findings hold. The point of diminishing returns on flexibility for Nuuchahnulth could be quite different from that of English.
