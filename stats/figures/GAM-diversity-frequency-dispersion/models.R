...
data_Eng_small              <- load_data("stats/figures/freq-DP_vs_diversity/Eng_small.csv")
data_Eng_small$log_rel_freq <- log2(data_Eng_small$rel_freq)

# Nuuchahnulth small corpus sample
data_Nuu_small              <- load_data("stats/figures/freq-DP_vs_diversity/Nuu_small.csv")
data_Nuu_small$log_rel_freq <- log2(data_Nuu_small$rel_freq)

# English 100-item sample
data_Eng_100              <- load_data("stats/figures/freq-DP_vs_diversity/Eng_100.csv")
data_Eng_100$log_rel_freq <- log2(data_Eng_100$rel_freq)

# Nuuchahnulth 100-item sample
data_Nuu_100              <- load_data("stats/figures/freq-DP_vs_diversity/Nuu_100.csv")
